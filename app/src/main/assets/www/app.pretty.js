...
void 0===r&&(r=!0),this.oAssetData={
}
,this.assetsLoaded=0,this.textData={
}
,this.spinnerRot=0,this.totalAssets=t.length,this.showBar=r;
for(var o=0;
o<t.length;
o++)-1!=t[o].file.indexOf(".json")?this.loadJSON(t[o]):this.loadImage(t[o]);
...
for(var a=0;
a<t.length;
a++)-1!=t[a].file.indexOf(".json")?this.loadJSON(t[a]):this.loadImage(t[a])}
...
,t.oAssetData[e.id].img=a,t.oAssetData[e.id].oData={
}
;
...
none:{
x:0,y:0,width:t.oAssetData[e.id].oData.spriteWidth,height:t.oAssetData[e.id].oData.spriteHeight}
}
,++t.assetsLoaded,t.checkLoadComplete()}
,a.src=e.file}
,e.prototype.getSpriteSize=function(e){
for(var t=[],a="",s="",i=0,r=e.lastIndexOf("."),o=!0;
o;
)r--,0==i&&this.isNumber(e.charAt(r))?a=e.charAt(r)+a:0==i&&a.length>0&&"x"==e.charAt(r)?(r--,i=1,s=e.charAt(r)+s):1==i&&this.isNumber(e.charAt(r))?s=e.charAt(r)+s:1==i&&s.length>0&&"_"==e.charAt(r)?(o=!1,t=[parseInt(s),parseInt(a)]):(o=!1,t=[0,0]);
return t}
...
var t=this.oAnims[this.animId].length,a=Math.floor(this.frameInc);
this.curFrame=this.oAnims[this.animId][a%t];
var s=this.curFrame*this.oImgData.oData.spriteWidth%this.oImgData.img.width,i=Math.floor(this.curFrame/(this.oImgData.img.width/this.oImgData.oData.spriteWidth))*this.oImgData.oData.spriteHeight;
...
var s=this.fixedFrame*this.oImgData.oData.spriteWidth%this.oImgData.img.width,i=Math.floor(this.fixedFrame/(this.oImgData.img.width/this.oImgData.oData.spriteWidth))*this.oImgData.oData.spriteHeight}
}
else var s=this.fixedFrame*this.oImgData.oData.spriteWidth%this.oImgData.img.width,i=Math.floor(this.fixedFrame/(this.oImgData.img.width/this.oImgData.oData.spriteWidth))*this.oImgData.oData.spriteHeight;
...
var t=this.frameNum*this.oImgData.oData.spriteWidth%this.oImgData.img.width,a=Math.floor(this.frameNum/(this.oImgData.img.width/this.oImgData.oData.spriteWidth))*this.oImgData.oData.spriteHeight;
...
,!1),e.addEventListener("contextmenu",
function(e){
...
t++)a.hitDown(e,e.changedTouches[t].pageX*canvasScale,e.changedTouches[t].pageY*canvasScale,e.changedTouches[t].identifier)}
,!1),e.addEventListener("touchend",
function(e){
for(var t=0;
t<e.changedTouches.length;
t++)a.hitUp(e,e.changedTouches[t].pageX*canvasScale,e.changedTouches[t].pageY*canvasScale,e.changedTouches[t].identifier)}
,!1),e.addEventListener("touchcancel",
function(e){
for(var t=0;
t<e.changedTouches.length;
t++)a.hitCancel(e,e.changedTouches[t].pageX*canvasScale,e.changedTouches[t].pageY*canvasScale,e.changedTouches[t].identifier)}
,!1),e.addEventListener("touchmove",
function(e){
for(var t=0;
t<e.changedTouches.length;
t++)a.move(e,e.changedTouches[t].pageX*canvasScale,e.changedTouches[t].pageY*canvasScale,e.changedTouches[t].identifier,!0)}
,!1),e.addEventListener("wheel",
function(e){
a.wheelScroll(e,e.deltaY)}
,!1),e.addEventListener("mousedown",
function(e){
a.isDown=!0,a.hitDown(e,a.mouseX,a.mouseY,1)}
,!1),e.addEventListener("mouseup",
function(e){
a.isDown=!1,a.hitUp(e,a.mouseX,a.mouseY,1)}
,!1),e.addEventListener("mousemove",
function(e){
a.move(e,a.mouseX,a.mouseY,1,a.isDown)}
,!1),e.addEventListener("mouseout",
function(e){
2!=e.button&&(clearButtonOvers(),a.isDown=!1,a.hitUp(e,Math.abs(a.mouseX),Math.abs(a.mouseY),1))}
,!1),this.aHitAreas=[],this.aKeys=[]}
return e.prototype.pointerLockOn=function(){
}
,e.prototype.pointerLockOff=function(){
}
,e.prototype.wheelScroll=function(e,t){
...
for(var i=new Date().getTime(),r=0;
r<this.aHitAreas.length;
r++)if(this.aHitAreas[r].rect){
var o=canvas.width*this.aHitAreas[r].align[0],n=canvas.height*this.aHitAreas[r].align[1];
...
for(var i=0;
i<this.aHitAreas.length;
i++)if(this.aHitAreas[i].rect){
var r=canvas.width*this.aHitAreas[i].align[0],o=canvas.height*this.aHitAreas[i].align[1];
if(t>r+this.aHitAreas[i].area[0]&&a>o+this.aHitAreas[i].area[1]&&t<r+this.aHitAreas[i].area[2]&&a<o+this.aHitAreas[i].area[3]){
for(var n=0;
n<this.aHitAreas[i].aTouchIdentifiers.length;
n++)this.aHitAreas[i].aTouchIdentifiers[n]==s&&(this.aHitAreas[i].aTouchIdentifiers.splice(n,1),n-=1);
...
for(var i=0;
i<this.aHitAreas.length;
i++)this.aHitAreas[i].oData.isDown&&(this.aHitAreas[i].oData.isDown=!1,this.aHitAreas[i].aTouchIdentifiers=[],this.aHitAreas[i].oData.multiTouch&&(this.aHitAreas[i].oData.x=t,this.aHitAreas[i].oData.y=a,this.aHitAreas[i].callback(this.aHitAreas[i].id,this.aHitAreas[i].oData)))}
...
for(var l=0;
l<this.aHitAreas[r].aTouchIdentifiers.length;
l++)this.aHitAreas[r].aTouchIdentifiers[l]==s&&(this.aHitAreas[r].aTouchIdentifiers.splice(l,1),l-=1);
...
for(var t=0;
t<this.aKeys.length;
t++)e.keyCode==this.aKeys[t].keyCode&&(e.preventDefault(),this.aKeys[t].oData.isDown=!0,this.aKeys[t].callback(this.aKeys[t].id,this.aKeys[t].oData))}
,e.prototype.keyUp=function(e){
for(var t=0;
t<this.aKeys.length;
t++)e.keyCode==this.aKeys[t].keyCode&&(e.preventDefault(),this.aKeys[t].oData.isDown=!1,this.aKeys[t].callback(this.aKeys[t].id,this.aKeys[t].oData))}
...
id:e,callback:t,oData:a,keyCode:s}
),this.checkKeyFocus()}
,e.prototype.removeKey=function(e){
for(var t=0;
t<this.aKeys.length;
t++)this.aKeys[t].id==e&&(this.aKeys.splice(t,1),t-=1)}
,e.prototype.addHitArea=function(e,t,a,s,i,r){
void 0===r&&(r=!1),null==a&&(a={
}
),r&&this.removeHitArea(e),i.scale||(i.scale=1),i.align||(i.align=[0,0]);
var o,n=[];
switch(s){

case"image":o=[i.aPos[0]-i.oImgData.oData.oAtlasData[i.id].width/2*i.scale,i.aPos[1]-i.oImgData.oData.oAtlasData[i.id].height/2*i.scale,i.aPos[0]+i.oImgData.oData.oAtlasData[i.id].width/2*i.scale,i.aPos[1]+i.oImgData.oData.oAtlasData[i.id].height/2*i.scale],this.aHitAreas.push({
id:e,aTouchIdentifiers:n,callback:t,oData:a,rect:!0,area:o,align:i.align}
);
break;

case"rect":this.aHitAreas.push({
id:e,aTouchIdentifiers:n,callback:t,oData:a,rect:!0,area:i.aRect,align:i.align}
)}
}
,e.prototype.removeHitArea=function(e){
for(var t=0;
t<this.aHitAreas.length;
t++)this.aHitAreas[t].id==e&&(this.aHitAreas.splice(t,1),t-=1)}
,e.prototype.resetAll=function(){
for(var e=0;
e<this.aHitAreas.length;
e++)this.aHitAreas[e].oData.isDown=!1,this.aHitAreas[e].oData.isBeingDragged=!1,this.aHitAreas[e].aTouchIdentifiers=[];
this.isDown=!1}
,e}
();
e.UserInput=t}
...
var e=this.bgId;
for(this.bgId=Math.floor(5*Math.random());
e==this.bgId;
)this.bgId=Math.floor(5*Math.random());
...
disconnectInc:1,ease:"Cubic.easeOut",onComplete:function(){
t.adBlocktween=TweenLite.to(t,.5,{
disconnectInc:0,delay:3,ease:"Cubic.easeIn"}
)}
}
)}
...
adBlockInc:0,ease:"Cubic.easeOut",onComplete:function(){
e.adBlocktween=TweenLite.to(e,.5,{
adBlockInc:1,delay:3,ease:"Cubic.easeIn"}
)}
}
)}
...
pvpStartInc:0,ease:"Cubic.easeOut",onComplete:function(){
TweenLite.to(e,.3,{
pvpStartInc:1,delay:.5,ease:"Cubic.easeIn"}
)}
}
)}
...
mapScale:1,ease:"Cubic.easeOut",onComplete:function(){
...
aEffects.push(s)}
TweenLite.to(t,1,{
mapScale:1.6,mapPos:1,ease:"Cubic.easeInOut",onComplete:function(){
}
}
),TweenLite.to(t,.5,{
mapPinScale:1,ease:"Back.easeOut",onComplete:function(){
...
congratsInc:0,ease:"Cubic.easeOut",onComplete:function(){
e.congratsTween=TweenLite.to(e,.25,{
congratsInc:1,delay:1,ease:"Cubic.easeIn"}
)}
}
)}
...
levelCompleteInc:0,ease:"Cubic.easeOut",onComplete:function(){
}
}
...
bugTimeY:0,ease:"Cubic.easeOut",onComplete:function(){
e.bugTimeTween=TweenLite.to(e,.5,{
bugTimeY:-1,delay:1,ease:"Cubic.easeIn",onComplete:function(){
e.bugTimeY=1}
}
)}
}
...
starsY:0,ease:"Bounce.easeOut"}
)}
,t.prototype.tweenCustomGameScore=function(e){
var t;
this.starsTween&&this.starsTween.kill(),this["scoreSideY"+e]=1,this.starsTween=TweenLite.to(this,.5,((t={
}
)["scoreSideY"+e]=0,t.ease="Bounce.easeOut",t))}
...
for(var e=Math.floor((curLevel+1)/levelsPerWorld),t=0;
t<aBatData.length;
t++)if(aBatData[t].unlockWorld==e){
batUnlockedId=t;
break}
}
...
batScale:1.5,ease:"Back.easeIn",onComplete:function(){
}
}
)}
...
delay:.35,userBatX:50,userBatY:-60,ease:"Back.easeOut",onComplete:function(){
e.movePlayerBat(0)}
}
),TweenLite.to(this,.5,{
delay:.8,enemyBatX:50,ease:"Back.easeOut",onComplete:function(){
}
}
),this.ballHeight=30,TweenLite.to(this,.55,{
delay:.5,ballX:30,ballY:-100,ease:"Linear.easeNone",onComplete:function(){
}
}
),TweenLite.to(this,.6,{
delay:.6,ballHeight:-30,ease:"Quad.easeIn",onComplete:function(){
}
}
)}
...
var t=this;
switch(e){
case 0:TweenLite.to(this,.5,{
userBatX:130,userBatY:85,ease:"Quad.easeInOut",onComplete:function(){
t.movePlayerBat(1)}
}
),TweenLite.to(this,.65,{
delay:.25,ballX:75,ballY:50,ease:"Quad.easeIn",onComplete:function(){
TweenLite.to(t,.65,{
ballX:-20,ballY:-100,ease:"Quad.easeOut",onComplete:function(){
}
}
)}
}
),TweenLite.to(this,.65,{
delay:.25,ballHeight:40,ease:"Quad.easeIn",onComplete:function(){
TweenLite.to(t,.65,{
ballHeight:-30,ease:"Quad.easeIn",onComplete:function(){
}
}
)}
}
...
break;
case 1:TweenLite.to(this,.5,{
delay:.3,userBatX:-30,userBatY:-60,ease:"Back.easeOut",onComplete:function(){
t.movePlayerBat(2)}
}
),TweenLite.to(this,.5,{
delay:.8,enemyBatX:-30,ease:"Back.easeOut",onComplete:function(){
}
}
);
break;
case 2:TweenLite.to(this,.5,{
userBatX:-130,userBatY:85,ease:"Quad.easeInOut",onComplete:function(){
t.movePlayerBat(3)}
}
),TweenLite.to(this,.65,{
...
for(var r=null,o=0;
o<this.aButs.length;
o++)this.aButs[o].id==e&&(this.aButs[o].id=t,this.aButs[o].idOver=a,r=this.aButs[o],s&&(this.aButs[o].aPos=s),i&&(this.aButs[o].align=i));
return r}
,t.prototype.removeBut=function(e){
for(var t=0;
t<this.aButs.length;
t++)this.aButs[t].id==e&&(this.aButs.splice(t,1),t-=1)}
...
case"network":ctx.fillStyle="rgba(0, 0, 0, 0.5)",ctx.fillRect(0,0,canvas.width,canvas.height);
var s=0,i="#000000",r="#FFFFFF";
...
case"credits":ctx.fillStyle="rgba(0, 0, 0, 0.5)",ctx.fillRect(0,0,canvas.width,canvas.height),addText(0,75,canvas.width-350,"center",canvas.width/2,80+this.butsY,"settings","#FFFFFF"),addText(0,23,canvas.width-100,"center",canvas.width/2,canvas.height-170+this.butsY,"createdBy","#ffffff");
...
case"resetConfirm":ctx.fillStyle="rgba(0, 0, 0, 0.65)",ctx.fillRect(0,0,canvas.width,canvas.height),addText(0,60,canvas.width-100,"center",canvas.width/2,canvas.height/2-100+this.butsY,"resetConfirm0","#FFFFFF"),addText(0,40,canvas.width-100,"center",canvas.width/2,canvas.height/2-40+this.butsY,"resetConfirm1","#FCEA02");
break;

case"game":if(gameplayState>=3){
var s=0;
...
var u,c,g,p,$,v,h=Math.max(onScreenY-200,60)+120,I=this.twoDigit(curLevel+1);
...
var o=getSpriteData(assetLib.getData("uiElements"),"progressCup"+c),_=canvas.width/2+110*b-(levelsPerWorld/2-.5)*110;
...
this.winGemTarg-=1;
var B={
x:canvas.width/2-85,y:h+250+200*this.levelCompleteInc,inc:1}
;
this.aWinGems.push(B),$=.5*this.winGemCount,v=125+200*Math.random(),TweenLite.to(B,.25,{
x:B.x+v*Math.cos($),y:B.y+v*Math.sin($),ease:"Quad.easeOut",onCompleteParams:[B],onComplete:function(e){
D=a.twoDigit(gems),TweenLite.to(e,.5,{
x:canvas.width-getDirectWidth(0,75,D)-95+27,y:canvas.height-80+25,inc:0,ease:"Quad.easeIn",onComplete:function(){
...
for(var b=0;
b<this.aWinGems.length;
b++)if(this.aWinGems[b].inc>0){
var o=getSpriteData(assetLib.getData("uiElements"),"bigGem");
...
for(var f=360*Math.random()*radian,w=0;
w<5;
w++){
...
var h=Math.max(onScreenY-200,60)+120,y=Math.floor((curLevel+1)/levelsPerWorld),I=this.twoDigit(y);
...
this.winGemTarg-=1;
var B={
x:canvas.width/2-25,y:h+200*this.levelCompleteInc+190+25,inc:1}
;
this.aWinGems.push(B),$=.5*this.winGemCount,v=125+200*Math.random(),TweenLite.to(B,.25,{
x:B.x+v*Math.cos($),y:B.y+v*Math.sin($),ease:"Quad.easeOut",onCompleteParams:[B],onComplete:function(e){
D=a.twoDigit(gems),TweenLite.to(e,.5,{
...
else if(gameplayState<5&&0==gameVariation)for(var b=0;
b<levelStarTarg;
b++){
var s=0;
curLevelStars>b&&(s=1);
...
var o=getSpriteData(assetLib.getData("flags"),"flag"+aSeasonFlags[saveDataHandler.getRound()].id),u=1;
...
var x,H=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].x,A=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].y,T=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].width,G=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].height;
...
var H=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+curBat]].x,A=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+curBat]].y,T=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+curBat]].width,G=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+curBat]].height;
...
var x=canvas.width/2+45+35.5,k=Math.max(onScreenY-170,100)-83+46.5;
...
case"batShop":ctx.fillStyle="rgba(0, 0, 0, 0.5)",ctx.fillRect(0,0,canvas.width,canvas.height),addText(0,75,canvas.width-350,"center",canvas.width/2,75,"batCollection","#FFFFFF");
var D=this.twoDigit(gems);
...
case"awards":ctx.fillStyle="rgba(0, 0, 0, 0.5)",ctx.fillRect(0,0,canvas.width,canvas.height);
for(var b=0;
b<16;
b++){
var s=16;
1==saveDataHandler.getAwardState(b)&&(s=b);
var o=getSpriteData(assetLib.getData("awards"),"award"+s),_=canvas.width/2-285+b%4*190,h=canvas.height/2+70-400+199*Math.floor(b/4)+this.posY,u=.9;
ctx.drawImage(o.img,o.bX,o.bY,o.bWidth,o.bHeight,_-o.bWidth/2*u,h-o.bHeight/2*u,o.bWidth*u,o.bHeight*u);
for(var C=getMultiLineTextByChars("awardInfo"+b,16,1),w=0;
w<C.length;
w++)addDirectText(1,25,200,"center",_,h+93+25*w,C[w],"#FFFFFF")}
break;

case"mapScreen":ctx.fillStyle="rgba(0, 0, 0, 0.5)",ctx.fillRect(0,0,canvas.width,canvas.height);
var o=getSpriteData(assetLib.getData("uiElements"),"map"),E=o.bWidth/2,Y=aFlags[aSeasonFlags[saveDataHandler.getRound()].id].x,L=aFlags[aSeasonFlags[saveDataHandler.getRound()].id].y,u=Math.min(1,canvas.width/o.bWidth)*this.mapScale,_=canvas.width/2-Y*u*this.mapPos*E,h=.5*canvas.height-L*u*this.mapPos*E+800/canvas.height*70*this.mapPos;
...
for(var b=1;
b<aSeasonFlags.length;
b++){
var P=_+aFlags[aSeasonFlags[b-1].id].x*E*u,W=h+aFlags[aSeasonFlags[b-1].id].y*E*u,O=_+aFlags[aSeasonFlags[b].id].x*E*u,X=h+aFlags[aSeasonFlags[b].id].y*E*u;
b<=saveDataHandler.getRound()&&(ctx.beginPath(),ctx.moveTo(P,W),ctx.quadraticCurveTo(P+(O-P)/2,W+(X-W)/2-100*u,O,X),ctx.stroke())}
ctx.setLineDash([]);
for(var b=0;
b<aSeasonFlagsRender.length;
b++){
var M,V=1,R=0;
...
case"pause":ctx.fillStyle="rgba(0, 0, 0, 0.5)",ctx.fillRect(0,0,canvas.width,canvas.height),addText(0,40,canvas.width/2,"center",canvas.width/2,canvas.height/2-110+110+this.butsY,"continue","#FFFFFF"),addText(0,40,canvas.width/2,"center",canvas.width/2,canvas.height/2+110+110+this.butsY,"quit","#FFFFFF")}
this.congratsUpdate(),t&&this.addButs()}
,t.prototype.getLatencyStatus=function(e){
return e<=50?0:e<=100?1:e<=180?2:e<=230?3:4}
,t.prototype.renderPointer=function(){
}
,t.prototype.renderBat=function(e,t,a,s){
...
var i=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+e]].x,r=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+e]].y,o=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+e]].width,n=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+e]].height;
...
var r=this.oUiElementsImgData.oData.oAtlasData[oImageIds["flare"+i]].x,o=this.oUiElementsImgData.oData.oAtlasData[oImageIds["flare"+i]].y,n=this.oUiElementsImgData.oData.oAtlasData[oImageIds["flare"+i]].width,l=this.oUiElementsImgData.oData.oAtlasData[oImageIds["flare"+i]].height;
...
var l=canvas.width*this.aButs[t].align[0],m=canvas.height*this.aButs[t].align[1];
...
incY:180*radian,rotation:e*radian,x:canvas.width/2,y:onScreenY+355,ease:"none",onComplete:function(){
}
}
)}
...
startY:onScreenY+200,ease:"Cubic.easeOut",onComplete:function(){
e.y=e.prevY=e.startY,TweenLite.to(e,.5,{
startInc:0,ease:"Cubic.easeInOut"}
)}
}
)}
...
flipX:4*Math.PI,ease:"Quad.easeOut",onComplete:function(){
e.flipX=Math.PI}
}
)}
...
x:this.hitX,y:this.hitY,speed:(.3+.3/.4*(.4-this.hitY))*.9,spin:0}
}
,e.prototype.render=function(){
...
var t=0,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].x,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].y,i=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].width,r=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].height;
...
var o=curBat,t=0;
o>=49&&(t=o);
var a=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].x,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].y,i=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].width,r=this.oGameElementsImgData.oData.oAtlasData[oImageIds["batBehind"+t]].height;
...
var a=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+o]].x,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+o]].y,i=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+o]].width,r=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+o]].height;
ctx.drawImage(this.oGameElementsImgData.img,a,s,i,r,-i/2*(1-Math.abs(Math.sin(this.flipX))),-r/3,i*(1-Math.abs(Math.sin(this.flipX))),r),ctx.restore()}
,e}
();
e.UserBat=t}
...
rotation:360*radian,incY:180*radian,scale:0,ease:"Quad.easeOut",onComplete:function(){
}
}
)}
...
targX:0,targY:0,ease:"Quad.easeInOut",onComplete:function(){
...
flailInc:t,ease:"Quad.easeInOut",onComplete:function(){
TweenLite.to(e,.5,{
flailInc:0,ease:"Quad.easeInOut"}
)}
}
)}
...
var r=t*t*tableDepth*(1+tableTop.offsetY/2)/2,o=r*(tableTop.offsetX+.6*e)*num128*(1+tableTop.offsetY/2)+e*tableBackWidth/2+100*a;
this.moveTween=TweenLite.to(this,.6*Math.random()+.5+(1-this.skillLevel)*.75,{
delay:.2*Math.random(),targX:o+i,targY:r,ease:this.aEases[Math.floor(Math.random()*this.aEases.length)],onComplete:function(){
"enemy"==aBalls[curBallId].lastHit&&(s.moveTween=TweenLite.to(s,.6*Math.random()+.5+(1-s.skillLevel)*.75,{
delay:.6*Math.random()*(1+(1-s.skillLevel)*1),targX:200*Math.random()-100,targY:0,ease:"Quad.easeInOut"}
))}
}
)}
else this.trackBall=!0,this.slideInc=0,this.moveTween=TweenLite.to(this,(.6*Math.random()+.5)*(1+(1-this.skillLevel)*1),{
targY:0,ease:"Quad.easeInOut"}
)}
,e.prototype.successFlip=function(){
var e=this;
this.swipeTween&&this.swipeTween.kill(),this.flipX=1,this.swipeTween=TweenLite.to(this,.5,{
flipX:-1,ease:"Bounce.easeInOut",onComplete:function(){
e.flipX=1}
}
)}
...
swipeOffsetX:100*Math.random()-50,flipX:e,flipY:t,ease:"Cubic.easeOut",onComplete:function(){
a.swipeTween=TweenLite.to(a,.5,{
swipeOffsetX:0,flipX:1,flipY:1,ease:"Back.easeOut",onComplete:function(){
}
}
)}
}
...
delay:.6*Math.random()*(1+(1-this.skillLevel)*1),targX:200*Math.random()-100,targY:0,ease:"Quad.easeInOut"}
...
x:this.hitX,y:this.hitY,speed:s,spin:a}
}
,e.prototype.render=function(){
...
var e=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].x,t=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].y,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].width,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds["bat"+opBat]].height;
...
servePosInc:1,ease:"Quad.easeOut",onComplete:function(){
t.canHit=!0}
}
)))}
...
if(this.targBounceX=t.x,this.targBounceY=t.y,this.speed=.5*t.speed,.27==this.speed)for(var a=360*Math.random()*radian,s=0;
s<8;
s++){
...
return{
x:e/3,y:.75,speed:.3+.3/.4*(.75-.6)*.25,spin:0}
}
...
x:1*Math.random()-.5,y:.25,speed:.3,spin:0}
):1==gameVariation&&this.setBouncePoint({
x:0,y:.25,speed:.3,spin:0}
...
var t=userBat.x-this.x,a=userBat.y-100*userBat.scale+130*userBat.scale*Math.max(userBat.batSpreadX,userBat.batSpreadY)-(this.y-this.height*(3*this.scale)-16),s=Math.sqrt(t*t+a*a);
...
offTableVX:0,offTableVY:0,ease:"Quad.easeOut"}
...
var o=this.x-tableTop.holeX,n=this.y-tableTop.holeY;
...
x:this.x,y:this.y,height:this.height,scale:this.scale,power:(this.speed-.12)/.12}
...
return}
var l=1+Math.min(Math.abs(userBat.prevX-userBat.x),225)*userBat.batSpreadMultiplier,m=1+Math.min(Math.abs(userBat.prevY-userBat.y),225)*userBat.batSpreadMultiplier;
...
x:Math.max(Math.min(.75*this.tablePosX,.8),-.8),y:.8,speed:.3,spin:0}
))}
}
}
...
var e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].x,t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].y,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].width,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.ballShadow].height;
...
if(this.aTrailPoints.length>1&&this.scale>0)for(var e=0;
e<this.aTrailPoints.length;
e++)ctx.fillStyle="rgba(255, 255, 100,"+e/this.aTrailPoints.length*.3+")",ctx.beginPath(),ctx.arc(this.aTrailPoints[e].x,this.aTrailPoints[e].y-this.aTrailPoints[e].height*(3*this.aTrailPoints[e].scale)-23,20*this.scale,0,2*Math.PI),ctx.fill()}
,t}
();
e.Ball=t}
(Elements||(Elements={
...
this.zombieBase={
x:0,y:0,offsetX:0,offsetY:.25,energy:1,height:0}
,this.aZombies=[];
for(var e=0;
e<Math.min(bugWave+5,15);
e++)this.aZombies.push(this.resetZombie(e))}
,t.prototype.resetZombie=function(e){
var t={
id:e,x:0,y:0,offsetX:0,offsetY:0,startX:2*Math.random()-1,startY:.3*Math.random()+.1,endX:1.6*Math.random()-.8,endY:.3*Math.random()+.1,energy:1,height:0,speed:.05*Math.random()+.05,scale:1,tweenScale:0,canHit:!0}
,a=TweenLite.to(t,.5,{
tweenScale:1,ease:"Back.easeOut",onComplete:function(){
}
}
);
return t.tween=a,t}
...
for(var s=this,i=0;
i<this.aZombies.length;
i++){
var r=t-this.aZombies[i].x,o=a-this.aZombies[i].y;
...
tweenScale:0,ease:"Cubic.easeOut",onCompleteParams:[this,h],onComplete:function(e,t){
...
zoomScale:3*this.zoomScale,zoomAlpha:0,ease:"Cubic.easeOut",onComplete:function(){
}
}
)}
...
holeOffsetX:0,holeOffsetY:.3,holeHitScale:Math.max(this.holeFixedScale*=.97,.35),ease:"Quad.easeInOut",onComplete:function(){
}
}
)}
,t.prototype.changeHolePos=function(){
this.targId=0,this.holeTween=TweenLite.to(this,.25,{
holeOffsetX:1.2*Math.random()-.6,holeOffsetY:.25*Math.random()+.2,holeHitScale:Math.max(this.holeFixedScale*=.97,.35),ease:"Quad.easeInOut",onComplete:function(){
}
}
)}
...
holeHitScale:0,ease:"Back.easeIn",onComplete:function(){
t.changeHolePos()}
}
);
for(var a=30*radian,s=0;
s<20;
s++){
...
botY:50,ease:"Bounce.easeOut",onComplete:function(){
}
}
)}
...
stopHeight:Math.floor(1.5*Math.random()),ease:"Quad.easeOut"}
)):(this.stopTweenVert&&this.stopTweenVert.kill(),this.canChangeStop=!0,this.stopTweenVert=TweenLite.to(this,.2,{
stopHeight:1,stopOffsetX:1*Math.random()-.5,ease:"Quad.easeOut"}
))}
...
offsetX:r,offsetY:o,ease:"Quad.easeOut"}
)}
...
var t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.bot].x,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.bot].y,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.bot].width,e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.bot].height,i=onScreenY+50*this.offsetY;
...
if(3==gameVariation){
var r=getSpriteData(assetLib.getData("bugs"),"bugBack"),o=canvas.width/2+this.offsetX*(0*this.segs)*3*this.edgeMultuplier*this.genScale+this.offsetX*this.edgeMultuplier*this.sideMultiplier,n=onScreenY+50*this.offsetY;
...
var t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].x,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].y,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].width,e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableClip].height;
...
ctx.save(),ctx.beginPath(),ctx.moveTo(canvas.width/2-l+c+2*this.genScale,i+2*this.genScale),ctx.lineTo(canvas.width/2+l+c-2*this.genScale,i+2*this.genScale),ctx.lineTo(canvas.width/2+h+p-6*this.genScale,u),ctx.lineTo(canvas.width/2-h+p+6*this.genScale,u),ctx.lineTo(canvas.width/2-l+c+2*this.genScale,i+2*this.genScale),ctx.closePath(),ctx.clip();
var t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.netReflect].x,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.netReflect].y,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.netReflect].width,e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.netReflect].height;
...
var t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.batShadow].x,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.batShadow].y,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.batShadow].width,e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.batShadow].height;
...
ctx.restore();
var t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].x,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].y,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].width,e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.tableEdge].height;
...
var e=this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].x,t=this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].y,a=this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].width,s=this.oGameElementsImgData.oData.oAtlasData[oImageIds.net].height;
...
for(var i=0;
i<e[s].length;
i++)t+=parseInt(e[s][i]["@xadvance"]),0==i?t-=parseInt(e[s][i]["@xoffset"]):i==e[s].length-1&&(t+=parseInt(e[s][i]["@xoffset"]));
a.push(t)}
return a}
...
i<e[s].length;
i++)for(var r=0;
r<assetLib.textData["fontData"+t].text.chars.char.length;
r++)e[s][i].charCodeAt(0)==assetLib.textData["fontData"+t].text.chars.char[r]["@id"]&&a[s].push(assetLib.textData["fontData"+t].text.chars.char[r])}
return a}
,e.prototype.renderText=function(e){
var t,a=this.oTextData[e.text].aLineData,s=this.oTextData[e.text].oFontImgData,i=0,r=0,o=0,n=1,l=0;
...
d<a[h].length;
d++){
var u=a[h][d]["@x"],c=a[h][d]["@y"],g=a[h][d]["@width"],p=a[h][d]["@height"];
...
return{
bX:e%12*124+30.5,bY:85.5*Math.floor(e/12)+14,bWidth:85.5,bHeight:59}
}
,e.prototype.randomise=function(e){
for(var t=e.length-1;
t>0;
t--){
var a=Math.floor(Math.random()*(t+1)),s=e[t];
e[t]=e[a],e[a]=s}
return e}
,e}
();
...
TweenLite.to(this,.5,{
scaleX:this.endScale,scaleY:this.endScale,ease:"Quad.easeOut"}
)}
...
for(var e=0;
e<42;
e++)this.aLevelStore.push(0);
for(var e=0;
e<this.batCount;
e++)0==e?this.aLevelStore.push(2):e<3?this.aLevelStore.push(1):this.aLevelStore.push(0);
for(var e=0;
e<16;
e++)this.aLevelStore.push(0)}
...
if(null!=localStorage.getItem(this.saveDataId)&&""!=localStorage.getItem(this.saveDataId))for(var e in this.aLevelStore=localStorage.getItem(this.saveDataId).split(","),this.aLevelStore)this.aLevelStore[e]=parseInt(this.aLevelStore[e]);
else this.saveData()}
}
...
for(var e=0,t=0;
t<this.batCount;
t++)this.aLevelStore[t+this.addedIndex]>0&&e++;
return e}
,e.prototype.selectBat=function(e){
for(var t=0;
t<this.batCount;
t++)if(2==this.aLevelStore[t+this.addedIndex]){
...
if(this.canStore&&"undefined"!=typeof Storage){
for(var e="",t=0;
t<this.aLevelStore.length;
t++)e+=this.aLevelStore[t],t<this.aLevelStore.length-1&&(e+=",");
...
TweenLite.to(this,h,{
scale:a,x:this.x-s*Math.cos(i),y:this.y-s*Math.sin(i),ease:"Cubic.easeOut",onComplete:function(){
m.removeMe=!0}
}
)}
...
scale:0,x:this.x+this.dist*Math.cos(this.angle),y:this.y+this.dist*Math.sin(this.angle),ease:"Cubic.easeOut",onComplete:function(){
i.removeMe=!0}
}
)}
return e.prototype.update=function(){
...
if(this.glowId=null,t>100&&t<canvas.height-100)for(var a=0;
a<aBatData.length;
a++)e>aBatData[a].x-this.gapX/2&&e<aBatData[a].x+this.gapX/2&&t>aBatData[a].y-this.gapY/2&&t<aBatData[a].y+this.gapY/2&&(this.glowId=a)}
...
y:0,ease:"Cubic.easeOut",onComplete:function(){
t.awardTween=TweenLite.to(t,.5,{
y:1,delay:2,ease:"Cubic.easeIn",onComplete:function(){
}
}
)}
}
...
if(this.y<1){
this.inc+=delta;
var e=getSpriteData(assetLib.getData("awards"),"awardBg"),t=canvas.width-100-e.bWidth/2,a=-200*this.y;
...
for(var s=getMultiLineTextByChars("awardInfo"+this.id,16,1),i=0;
i<s.length;
i++)addDirectText(1,25,200,"center",t,a+125+105+25*i,s[i],"#FFFFFF")}
}
,e}
();
e.AwardPanel=t}
...
var e=this;
this.network=new netlib.Network(this.gameId),this.network.on("message",
function(e,t,a){
networkMessage(a)}
...
),this.network.on("signalingerror",
function(t){
...
codeFormat:"short",public:!0,maxPlayers:2}
)}
...
,canvas=document.getElementById("canvas"),ctx=canvas.getContext("2d"),maxWidth=800,minWidth=800,maxHeight=800,minHeight=800,canvasScale=1,div=document.getElementById("canvas-wrapper"),audioType=0,muted=!1,splashTimer=0,isMobile=!1,gameState="loading",aLangs=["EN"],curLang="",isBugBrowser=!1,isIE10=!1,radian=Math.PI/180,ios9FirstTouch=!1,isRotated=!1,saveDataHandler=new Utils.SaveDataHandler("ppgv8"),hasFocus=!0,assetIdInc=0;
...
setTimeout(function(){
resizeCanvas()}
,0),window.addEventListener("orientationchange",
function(){
setTimeout(function(){
resizeCanvas()}
...
var ua=navigator.userAgent,isSharpStock=/SHL24|SH-01F/i.test(ua)&&isStock(),isXperiaAStock=/SO-04E/i.test(ua)&&isStock(),isFujitsuStock=/F-01F/i.test(ua)&&isStock();
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:2}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:1,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:3}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:1,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:4}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:5}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:6}
,{
unlockId:1,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:7}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:1,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:8}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:9}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:3,x:0,y:0,gemCost:0,unlockWorld:10}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:9}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
,{
unlockId:2,x:0,y:0,gemCost:0,unlockWorld:0}
...
for(var e=50,t=50,a=0,s=0;
s<aBatData.length;
s++)2==aBatData[s].unlockId&&(aBatData[s].gemCost=10*Math.round(e/10),++a%3==0&&(t*=1.25,e+=t))}
...
case"latency":removeAllButs(),gameVariation=0,initStartScreen(),panel.showDisconnect("latency");
break;

case"rematch":startPvpGame();
break;

case"acceptPlayer":netLib.send(!0,"opData",[curBat,saveDataHandler.getPvpWins()]),initGame(),background.setRandom(),panel.showPvpStartMessage();
break;

case"lobby-not-found":removeAllButs(),gameVariation=0,initStartScreen(),panel.showDisconnect("noLobby");
break;

case"lobby-is-full":removeAllButs(),gameVariation=0,initStartScreen(),panel.showDisconnect("alreadyConnected");
break;

case"generalError":removeAllButs(),gameVariation=0,initStartScreen(),panel.showDisconnect("disconnected");
break;

case"connectError":initStartScreen(),panel.showDisconnect("unableToConnect");
break;

case"disconnected":"game"==gameState&&4==gameVariation&&(removeAllButs(),gameVariation=0,initStartScreen(),panel.showDisconnect("disconnected"));
break;

case"peerConnect":netLib.send(!0,"acceptPlayer"),startPvpGame();
break;

case"opData":opBat=parseInt(t[1]),opPvpWins=parseInt(t[2]),opBat==curBat&&(opBat=0==curBat?1:0);
break;

case"batPos":enemyBat.nX=parseFloat(t[1]),enemyBat.nY=parseFloat(t[2]),enemyBat.nRot=parseFloat(t[3]);
break;

case"serveBounce":playSound("hit"+Math.floor(6*Math.random())),rallyHits++,aBalls[0].height=parseFloat(t[6]),aBalls[0].tablePosX=parseFloat(t[4]),aBalls[0].tablePosY=1-parseFloat(t[5]),aBalls[0].setBouncePoint({
x:parseFloat(t[1]),y:parseFloat(t[2]),speed:parseFloat(t[3]),spin:0}
);
break;

case"offSide":aBalls[0].offSide=!0;
break;

case"hitBounce":playSound("hit"+Math.floor(6*Math.random())),rallyHits++,aBalls[0].offTablePvp=!1,aBalls[0].offTable=!1,aBalls[0].offTableTween&&aBalls[0].offTableTween.kill(),aBalls[0].servingState=2,aBalls[0].bounceNum=0,aBalls[0].lastHit="enemy",aBalls[0].height=parseFloat(t[6]),aBalls[0].tablePosX=parseFloat(t[4]),aBalls[0].tablePosY=1-parseFloat(t[5]),aBalls[0].setBouncePoint({
x:parseFloat(t[1]),y:parseFloat(t[2])+.1,speed:parseFloat(t[3]),spin:0}
);
break;

case"ballOff":1==parseInt(t[1])?updateScore("user"):updateScore("enemy"),aBalls[0].nextServeChoice();
break;

case"hitNet":aBalls[0].hasHitNetPvP=!0}
}
}
...
if(1==audioType){
var t=oImageIds.muteBut0,a=oImageIds.muteBut0Over;
muted&&(t=oImageIds.muteBut1,a=oImageIds.muteBut1Over);
var s={
oImgData:assetLib.getData("uiButs"),aPos:[-50,50],align:[1,0],id:t,idOver:a,noTween:!0}
;
userInput.addHitArea("mute",butEventHandler,null,"image",s);
for(var i=0;
i<e.length;
i++)if(e[i].id==oImageIds.muteBut0||e[i].id==oImageIds.muteBut1)return;
e.push(s)}
}
...
gameState="credits";
var e={
oImgData:assetLib.getData("uiButs"),aPos:[50,-50],align:[0,1],id:oImageIds.backBut,idOver:oImageIds.backButOver}
,t={
oImgData:assetLib.getData("uiButs"),aPos:[-50,-50],align:[1,1],id:oImageIds.resetBut,idOver:oImageIds.resetButOver}
;
...
var e={
oImgData:assetLib.getData("uiButs"),aPos:[-100,90],align:[.5,.5],id:oImageIds.tickBut,idOver:oImageIds.tickButOver}
,t={
oImgData:assetLib.getData("uiButs"),aPos:[100,90],align:[.5,.5],id:oImageIds.quitBut,idOver:oImageIds.quitButOver}
;
...
var e={
oImgData:assetLib.getData("uiButs"),aPos:[-100,54],align:[.5,.3],id:oImageIds.minusBut,idOver:oImageIds.minusButOver}
,t={
oImgData:assetLib.getData("uiButs"),aPos:[100,54],align:[.5,.3],id:oImageIds.plusBut,idOver:oImageIds.plusButOver}
;
...
var a={
oImgData:assetLib.getData("uiButs"),aPos:[-100,224],align:[.5,.3],id:oImageIds.minusBut,idOver:oImageIds.minusButOver}
,s={
oImgData:assetLib.getData("uiButs"),aPos:[100,224],align:[.5,.3],id:oImageIds.plusBut,idOver:oImageIds.plusButOver}
;
...
var e,t,a,s,i,r,o={
oImgData:assetLib.getData("uiButs"),aPos:[-140,50],align:[1,0],id:oImageIds.infoBut,idOver:oImageIds.infoButOver}
;
...
oImgData:assetLib.getData("uiButs"),aPos:[160,-250],align:[.5,1],id:oImageIds.awardsBut,idOver:oImageIds.awardsButOver}
,t={
oImgData:assetLib.getData("uiButs"),aPos:[320,-250],align:[.5,1],id:oImageIds.batShopBut,idOver:oImageIds.batShopButOver}
,a={
oImgData:assetLib.getData("uiButs"),aPos:[-160,-250],align:[.5,1],id:oImageIds.challengeBut,idOver:oImageIds.challengeButOver}
,i={
oImgData:assetLib.getData("uiButs"),aPos:[0,-250],align:[.5,1],id:oImageIds.careerBut,idOver:oImageIds.careerButOver}
,s={
oImgData:assetLib.getData("uiButs"),aPos:[-320,-250],align:[.5,1],id:oImageIds.bugGameBut,idOver:oImageIds.bugGameButOver}
,r={
oImgData:assetLib.getData("uiButs"),aPos:[320,-430],align:[.5,1],id:oImageIds.pvpGameBut,idOver:oImageIds.pvpGameButOver,flash:!0}
):r={
oImgData:assetLib.getData("uiButs"),aPos:[320,-250],align:[.5,1],id:oImageIds.pvpGameBut,idOver:oImageIds.pvpGameButOver,flash:!0}
...
oImgData:assetLib.getData("uiButs"),aPos:[-90,-390],align:[1,1],id:oImageIds.awardsBut,idOver:oImageIds.awardsButOver}
,t={
oImgData:assetLib.getData("uiButs"),aPos:[-90,-210],align:[1,1],id:oImageIds.batShopBut,idOver:oImageIds.batShopButOver}
,a={
oImgData:assetLib.getData("uiButs"),aPos:[90,-390],align:[0,1],id:oImageIds.challengeBut,idOver:oImageIds.challengeButOver}
,i={
oImgData:assetLib.getData("uiButs"),aPos:[90,-210],align:[0,1],id:oImageIds.careerBut,idOver:oImageIds.careerButOver}
,s={
oImgData:assetLib.getData("uiButs"),aPos:[90,-570],align:[0,1],id:oImageIds.bugGameBut,idOver:oImageIds.bugGameButOver}
,r={
oImgData:assetLib.getData("uiButs"),aPos:[-90,-570],align:[1,1],id:oImageIds.pvpGameBut,idOver:oImageIds.pvpGameButOver,flash:!0}
):r={
oImgData:assetLib.getData("uiButs"),aPos:[-90,-210],align:[1,1],id:oImageIds.pvpGameBut,idOver:oImageIds.pvpGameButOver,flash:!0}
,userInput.addHitArea("startTouch",butEventHandler,null,"rect",{
...
for(var e=0;
e<aBatData.length;
e++)saveDataHandler.getBatUnlockState(e)>0&&(aBatData[e].unlockId=0)}
...
for(var t=0;
t<aSeasonFlags.length;
t++)aSeasonFlagsRender.push({
aSeasonFlagsIndex:t,y:aFlags[aSeasonFlags[t].id].y}
);
...
function addMapButs(){
var e={
oImgData:assetLib.getData("uiButs"),aPos:[0,50],align:[.5,.7],id:oImageIds.playBut,idOver:oImageIds.playButOver,flash:!0}
;
...
for(var e=Math.floor(Math.random()*aBatData.length);
0!=aBatData[e].unlockWorld||e==curBat;
)e=Math.floor(Math.random()*aBatData.length);
return e}
...
case"customGameEnd":t&&addRewardGems(rewardGemTotal),initCustomGameEndButs();
break;

case"levelComplete":t&&addRewardGems(rewardGemTotal),initLevelCompleteButs();
break;

case"targetGameEnd":t&&addRewardGems(rewardGemTotal),initTargetGameEndButs();
break;

case"bugGameEnd":t&&addRewardGems(rewardGemTotal),initBugGameEndButs();
break;

case"batUnlock":userInput.removeHitArea("backFromBatShop"),userInput.removeHitArea("batShopTouch"),panel.removeBut(oImageIds.backBut),t&&(playSound("unlockBat",.5),saveDataHandler.unlockBat(a),saveDataHandler.selectBat(a),curBat=saveDataHandler.getCurBat(),updateBatShopData(),awardPanel.checkForAward(curLevel),batShop.batUnlocked()),initBatShopButs()}
}
...
,!0);
var e={
oImgData:assetLib.getData("uiButs"),aPos:[0,230],align:[.5,.5],id:oImageIds.shareBut,idOver:oImageIds.shareButOver,flash:!0}
;
...
,!0);
var e={
oImgData:assetLib.getData("uiButs"),aPos:[-140,50],align:[1,0],id:oImageIds.pauseBut,idOver:oImageIds.pauseButOver}
;
...
var e={
oImgData:assetLib.getData("uiButs"),aPos:[0,-110],align:[.5,.5],id:oImageIds.continueBut,idOver:oImageIds.continueButOver}
,t={
oImgData:assetLib.getData("uiButs"),aPos:[0,110],align:[.5,.5],id:oImageIds.quitBut,idOver:oImageIds.quitButOver}
;
...
,1e3),awardPanel.checkForAward(curLevel),curTargetScore>localTargetHighscore)for(var e=0;
e<200;
e++){
...
var t,a={
oImgData:assetLib.getData("uiButs"),aPos:[285,0],align:[.5,t],id:oImageIds.rewardMultiplyBut,idOver:oImageIds.rewardMultiplyButOver,flash:!0}
;
...
var r={
oImgData:assetLib.getData("uiButs"),aPos:[90,-390],align:[0,1],id:oImageIds.arcadeBut,idOver:oImageIds.arcadeButOver}
;
...
var l={
oImgData:assetLib.getData("uiButs"),aPos:[-90,-390],align:[1,1],id:oImageIds.pvpGameBut,idOver:oImageIds.pvpGameButOver,flash:!0}
;
...
initBugGameEndButs()}
,1e3),awardPanel.checkForAward(curLevel),bugScore>localTargetHighscore)for(var e=0;
e<200;
e++){
var t=new Elements.Confetti(Math.random()*canvas.width,Math.random()*canvas.height);
aEffects.push(t)}
...
var o={
oImgData:assetLib.getData("uiButs"),aPos:[90,-570],align:[0,1],id:oImageIds.challengeBut,idOver:oImageIds.challengeButOver}
;
...
var t={
oImgData:assetLib.getData("uiButs"),aPos:[285,0],align:[.5,.4],id:oImageIds.rewardMultiplyBut,idOver:oImageIds.rewardMultiplyButOver,flash:!0}
;
...
var i={
oImgData:assetLib.getData("uiButs"),aPos:[90,-210],align:[0,1],id:oImageIds.arcadeBut,idOver:oImageIds.arcadeButOver}
;
...
var t,a,s={
oImgData:assetLib.getData("uiButs"),aPos:[285,a],align:[.5,t],id:oImageIds.rewardMultiplyBut,idOver:oImageIds.rewardMultiplyButOver,flash:!0}
;
...
for(var t=360*Math.random()*radian,a=0;
a<100;
a++){
...
case"infoFromStart":playSound("click"),removeStartButs(),initCreditsScreen();
break;

case"resetData":playSound("click"),userInput.removeHitArea("backFromCredits"),userInput.removeHitArea("resetData"),userInput.removeHitArea("minusGames"),userInput.removeHitArea("plusGames"),userInput.removeHitArea("minusSets"),userInput.removeHitArea("plusSets"),userInput.removeHitArea("mute"),initResetConfirmScreen();
break;

case"yesFromResetConfirm":playSound("loseStar",.5),saveDataHandler.resetData(),updateBatShopData(),resetFromSaveData(),userInput.removeHitArea("yesFromResetConfirm"),userInput.removeHitArea("noFromResetConfirm"),userInput.removeHitArea("mute"),initStartScreen();
break;

case"noFromResetConfirm":playSound("click"),userInput.removeHitArea("yesFromResetConfirm"),userInput.removeHitArea("noFromResetConfirm"),userInput.removeHitArea("mute"),initCreditsScreen();
break;

case"backFromCredits":playSound("click"),userInput.removeHitArea("backFromCredits"),userInput.removeHitArea("resetData"),userInput.removeHitArea("minusGames"),userInput.removeHitArea("plusGames"),userInput.removeHitArea("minusSets"),userInput.removeHitArea("plusSets"),userInput.removeHitArea("mute"),initStartScreen();
break;

case"plusGames":playSound("click"),saveDataHandler.setCareerGames(Math.min(saveDataHandler.getCareerGames()+1,21));
break;

case"minusGames":playSound("click"),saveDataHandler.setCareerGames(Math.max(saveDataHandler.getCareerGames()-1,8));
break;

case"plusSets":playSound("click"),saveDataHandler.setCareerSets(Math.min(saveDataHandler.getCareerSets()+1,5));
break;

case"minusSets":playSound("click"),saveDataHandler.setCareerSets(Math.max(saveDataHandler.getCareerSets()-1,2));
break;

case"startTouch":playSound("click"),removeStartButs(),gameVariation=0,showAd(initGame),enemyBat.trackBall=!0;
break;

case"batShopFromStart":t.isDown&&(batShopButDown=!0),t.isUp&&batShopButDown&&(batShopButDown=!1,playSound("click"),removeStartButs(),prevGameplayState=gameplayState,initBatShop());
break;

case"careerFromStart":playSound("click"),removeStartButs(),initMapScreen();
break;

case"bugGameFromStart":playSound("click"),removeStartButs(),gameVariation=3,initGame();
break;

case"pvpFromStart":playSound("click"),removeStartButs(),gameVariation=4,initPvpGame();
break;

case"urlFromNetwork":
case"urlAreaFromNetwork":playSound("click"),netLib.shareLobbyCode(function(e){
return panel.clipboardCallback(e)}
),userInput.removeHitArea("urlFromNetwork"),panel.removeBut(oImageIds.shareBut);
break;

case"backFromNetwork":userInput.removeHitArea("backFromNetwork"),userInput.removeHitArea("urlFromNetwork"),userInput.removeHitArea("urlAreaFromNetwork"),initStartScreen();
break;

case"customMatchFromStart":playSound("click"),removeStartButs(),gameVariation=2,initGame();
break;

case"challengeFromStart":playSound("click"),removeStartButs(),gameVariation=1,initGame();
break;

case"awardsFromStart":playSound("click"),removeStartButs(),prevGameplayState=gameplayState,initAwards();
break;

case"backFromBatShop":playSound("click"),newBatId=null,userInput.removeHitArea("batShopTouch"),userInput.removeHitArea("backFromBatShop"),panel.removeBut(oImageIds.backBut),0==prevGameplayState?initStartScreen():4==prevGameplayState?(gameState="game",panel.aWinGems=[],(curLevel+1)%levelsPerWorld==0?panel.winGemTarg=aPointScores[1]:panel.winGemTarg=aPointScores[0],panel.winGemCount=0,initLevelCompleteButs(),previousTime=new Date().getTime(),updateGameEvent()):6==prevGameplayState?(gameState="game",initWorldCompleteButs(),previousTime=new Date().getTime(),updateGameEvent()):8==prevGameplayState?(gameState="game",panel.aWinGems=[],panel.winGemTarg=Math.round(curTargetScore/2),panel.winGemCount=0,initTargetGameEndButs(),previousTime=new Date().getTime(),updateGameEvent()):10==prevGameplayState?(gameState="game",panel.aWinGems=[],userSets>enemySets?panel.winGemTarg=50+10*saveDataHandler.getSeason()+saveDataHandler.getRound():panel.winGemTarg=25,panel.winGemCount=0,initCustomGameEndButs(),previousTime=new Date().getTime(),updateGameEvent()):12==prevGameplayState&&(gameState="game",panel.aWinGems=[],panel.winGemTarg=Math.ceil(bugScore/4),panel.winGemCount=0,initBugGameEndButs(),previousTime=new Date().getTime(),updateGameEvent());
break;

case"batShopTouch":t.y>100&&t.y<canvas.height-100&&(t.isDown&&!t.isBeingDragged?(batShop.startMoveY=batShop.targY,batShop.checkMoveY=0,t.x<canvas.width/2+(batShop.blocksX-1)*batShop.gapX-batShop.gapX*(batShop.blocksX/2-1)+batShop.posX?(batShop.sideTouched=0,batShop.startTouchY=t.y-batShop.targY):(batShop.sideTouched=1,batShop.startTouchY=t.y+batShop.targY/(1/batShop.barPerc)),butDown=!0):t.isBeingDragged?0==batShop.sideTouched?(batShop.targY=t.y-batShop.startTouchY,batShop.checkMoveY+=Math.abs(batShop.startMoveY-batShop.targY)):1==batShop.sideTouched&&(batShop.targY=-(t.y-batShop.startTouchY)*(1/batShop.barPerc),batShop.checkMoveY+=Math.abs(batShop.startMoveY-batShop.targY)):butDown&&(butDown=!1,(!isMobile&&batShop.checkMoveY<3||isMobile&&batShop.checkMoveY<10)&&batShop.checkClick(t.x,t.y)));
break;

case"gameTouch":t.isDown&&!t.isBeingDragged?(swipeState=1,startTouchY=t.y-userBat.targY):1==swipeState&&t.isBeingDragged?(userBat.targX=t.x,0==controlState?userBat.targY=t.y:userBat.targY=t.y-startTouchY):1==swipeState&&(swipeState=0);
break;

case"playFromMapScreen":playSound("click"),userInput.removeHitArea("playFromMapScreen"),userInput.removeHitArea("backFromMapScreen"),firstCareerGame?prepForCareerMatch():showAd(prepForCareerMatch);
break;

case"backFromMapScreen":playSound("click"),userInput.removeHitArea("playFromMapScreen"),userInput.removeHitArea("backFromMapScreen"),initStartScreen();
break;

case"playFromPvpGameEnd":playSound("click"),userInput.removeHitArea("playFromPvpGameEnd"),userInput.removeHitArea("backFromPvpGameEnd"),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.backBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),startPvpGame(),netLib.send(!0,"rematch");
break;

case"backFromPvpGameEnd":playSound("click"),userInput.removeHitArea("playFromPvpGameEnd"),userInput.removeHitArea("backFromPvpGameEnd"),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.backBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),netLib.disconnect(),initStartScreen();
break;

case"playFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),initMapScreen();
break;

case"awardsFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),prevGameplayState=gameplayState,initAwards();
break;

case"batShopFromCustomGameEnd":t.isDown&&(batShopButDown=!0),t.isUp&&batShopButDown&&(batShopButDown=!1,playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),prevGameplayState=gameplayState,initBatShop());
break;

case"challengeFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=1,showAd(initGame);
break;

case"arcadeFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=0,showAd(initGame);
break;

case"bugGameFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=3,showAd(initGame);
break;

case"backFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),initStartScreen(!1);
break;

case"pvpFromCustomGameEnd":playSound("click"),userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=4,initPvpGame();
break;

case"rewardFromCustomGameEnd":userInput.removeHitArea("playFromCustomGameEnd"),userInput.removeHitArea("rewardFromCustomGameEnd"),userInput.removeHitArea("batShopFromCustomGameEnd"),userInput.removeHitArea("challengeFromCustomGameEnd"),userInput.removeHitArea("arcadeFromCustomGameEnd"),userInput.removeHitArea("backFromCustomGameEnd"),userInput.removeHitArea("bugGameFromCustomGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.arcadeBut),userInput.removeHitArea("pvpFromCustomGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showRewardAd("customGameEnd");
break;

case"playFromLevelComplete":playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),anyWorldBatsLeft()&&(curLevel+1)%levelsPerWorld==0?initWorldComplete():(curLevel=saveDataHandler.getLevel(),showAd(initNextLevel));
break;

case"batShopFromLevelComplete":t.isDown&&(batShopButDown=!0),t.isUp&&batShopButDown&&(batShopButDown=!1,playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),userInput.removeHitArea("pvpFromLevelComplete"),userInput.removeHitArea("pvpFromLevelComplete"),prevGameplayState=gameplayState,initBatShop());
break;

case"rewardFromLevelComplete":userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),showRewardAd("levelComplete");
break;

case"careerFromLevelComplete":playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),showAd(initMapScreen);
break;

case"challengeFromLevelComplete":playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=1,showAd(initGame);
break;

case"bugGameFromLevelComplete":playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=3,showAd(initGame);
break;

case"backFromLevelComplete":playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),initStartScreen(!1);
break;

case"pvpFromLevelComplete":playSound("click"),userInput.removeHitArea("playFromLevelComplete"),userInput.removeHitArea("batShopFromLevelComplete"),userInput.removeHitArea("rewardFromLevelComplete"),userInput.removeHitArea("careerFromLevelComplete"),userInput.removeHitArea("challengeFromLevelComplete"),userInput.removeHitArea("backFromLevelComplete"),userInput.removeHitArea("bugGameFromLevelComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromLevelComplete"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=4,initPvpGame();
break;

case"playFromWorldComplete":playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromWorldComplete"),panel.removeBut(oImageIds.pvpGameBut),curLevel++,showAd(initNextLevel);
break;

case"batShopFromWorldComplete":t.isDown&&(batShopButDown=!0),t.isUp&&batShopButDown&&(batShopButDown=!1,playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),userInput.removeHitArea("pvpFromWorldComplete"),prevGameplayState=gameplayState,initBatShop());
break;

case"customMatchFromWorldComplete":playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromWorldComplete"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=2,showAd(initGame);
break;

case"challengeFromWorldComplete":playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromWorldComplete"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=1,showAd(initGame);
break;

case"bugGameFromWorldComplete":playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromWorldComplete"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=3,showAd(initGame);
break;

case"careerFromWorldComplete":playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromWorldComplete"),panel.removeBut(oImageIds.pvpGameBut),showAd(initMapScreen);
break;

case"backFromWorldComplete":playSound("click"),userInput.removeHitArea("playFromWorldComplete"),userInput.removeHitArea("batShopFromWorldComplete"),userInput.removeHitArea("careerFromWorldComplete"),userInput.removeHitArea("challengeFromWorldComplete"),userInput.removeHitArea("backFromWorldComplete"),userInput.removeHitArea("bugGameFromWorldComplete"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromWorldComplete"),panel.removeBut(oImageIds.pvpGameBut),initStartScreen(!1);
break;

case"rewardFromTargetGameEnd":userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showRewardAd("targetGameEnd");
break;

case"playFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showAd(initGame);
break;

case"batShopFromTargetGameEnd":t.isDown&&(batShopButDown=!0),t.isUp&&batShopButDown&&(batShopButDown=!1,playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),prevGameplayState=gameplayState,initBatShop());
break;

case"backFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),initStartScreen(!1);
break;

case"pvpFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=4,initPvpGame();
break;

case"careerFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showAd(initMapScreen);
break;

case"arcadeFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=0,showAd(initGame);
break;

case"bugGameFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=3,showAd(initGame);
break;

case"awardsFromTargetGameEnd":playSound("click"),userInput.removeHitArea("playFromTargetGameEnd"),userInput.removeHitArea("batShopFromTargetGameEnd"),userInput.removeHitArea("careerFromTargetGameEnd"),userInput.removeHitArea("arcadeFromTargetGameEnd"),userInput.removeHitArea("awardsFromTargetGameEnd"),userInput.removeHitArea("rewardFromTargetGameEnd"),userInput.removeHitArea("backFromTargetGameEnd"),userInput.removeHitArea("bugGameFromTargetGameEnd"),panel.removeBut(oImageIds.bugGameBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromTargetGameEnd"),panel.removeBut(oImageIds.pvpGameBut),prevGameplayState=gameplayState,initAwards();
break;

case"rewardFromBugGameEnd":userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showRewardAd("bugGameEnd");
break;

case"playFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showAd(initGame);
break;

case"batShopFromBugGameEnd":t.isDown&&(batShopButDown=!0),t.isUp&&batShopButDown&&(batShopButDown=!1,playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),prevGameplayState=gameplayState,initBatShop());
break;

case"backFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),initStartScreen(!1);
break;

case"pvpFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=4,initPvpGame();
break;

case"careerFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),showAd(initMapScreen);
break;

case"arcadeFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=0,showAd(initGame);
break;

case"challengeFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),gameVariation=1,showAd(initGame);
break;

case"awardsFromBugGameEnd":playSound("click"),userInput.removeHitArea("playFromBugGameEnd"),userInput.removeHitArea("batShopFromBugGameEnd"),userInput.removeHitArea("careerFromBugGameEnd"),userInput.removeHitArea("arcadeFromBugGameEnd"),userInput.removeHitArea("awardsFromBugGameEnd"),userInput.removeHitArea("rewardFromBugGameEnd"),userInput.removeHitArea("backFromBugGameEnd"),userInput.removeHitArea("challengeFromBugGameEnd"),panel.removeBut(oImageIds.challengeBut),panel.removeBut(oImageIds.backBut),panel.removeBut(oImageIds.rewardMultiplyBut),panel.removeBut(oImageIds.awardsBut),panel.removeBut(oImageIds.playBut),panel.removeBut(oImageIds.batShopBut),panel.removeBut(oImageIds.arcadeBut),panel.removeBut(oImageIds.classicGameBut),panel.removeBut(oImageIds.careerBut),userInput.removeHitArea("pvpFromBugGameEnd"),panel.removeBut(oImageIds.pvpGameBut),prevGameplayState=gameplayState,initAwards();
break;

case"mute":playSound("click"),toggleMute(),muted?(panel.switchBut(oImageIds.muteBut0,oImageIds.muteBut1,oImageIds.muteBut1Over),saveDataHandler.setAudioState(1)):(panel.switchBut(oImageIds.muteBut1,oImageIds.muteBut0,oImageIds.muteBut0Over),saveDataHandler.setAudioState(0));
break;

case"keyPauseOn":t.isDown||butEventHandler("pause",null);
break;

case"pause":playSound("click"),1==audioType?(Howler.mute(!0),music.pause()):2==audioType&&music.pause(),userInput.removeHitArea("pause"),userInput.removeHitArea("gameTouch"),userInput.removeHitArea("mute"),userInput.removeKey("keyPauseOn"),initPause();
break;

case"keyPauseOff":t.isDown||butEventHandler("continueFromPause",null);
break;

case"continueFromPause":playSound("click"),1==audioType?muted||(Howler.mute(!1),playMusic()):2!=audioType||muted||playMusic(),userInput.removeHitArea("quitFromPause"),userInput.removeHitArea("continueFromPause"),userInput.removeHitArea("mute"),userInput.removeKey("keyPauseOff"),resumeGame();
break;

case"quitFromPause":t.isDown||t.isBeingDragged||t.hasLeft||(playSound("click"),1==audioType?muted||(Howler.mute(!1),playMusic()):2!=audioType||muted||playMusic(),userInput.removeHitArea("quitFromPause"),userInput.removeHitArea("continueFromPause"),userInput.removeHitArea("mute"),userInput.removeKey("keyPauseOff"),4==gameVariation&&netLib.disconnect(),gameVariation=0,initStartScreen())}
}
...
a<6;
a++)s.push({
id:t[a],rank:getEnemyRank()}
);
return sortBy(s,"rank",!1)}

function getEnemyRank(){
for(var e=saveDataHandler.getRank(),t=saveDataHandler.getSeason();
e==saveDataHandler.getRank();
)e=Math.ceil(Math.random()*Math.max(6-t,1)*30+60*Math.max(6-t,0));
return e}

function shuffleArray(e){
for(var t,a=e.length-1;
a>0;
a--){
...
return{
img:e.img,bX:e.oData.oAtlasData[oImageIds[t]].x,bY:e.oData.oAtlasData[oImageIds[t]].y,bWidth:e.oData.oAtlasData[oImageIds[t]].width,bHeight:e.oData.oAtlasData[oImageIds[t]].height}
}

function getMultiLineTextByChars(e,t,a){
for(var s=[],i=getText(e,a);
i.length>t;
){
var r=i.substring(0,t).lastIndexOf(" ");
-1==r?(s.push(i.substring(0,t)+"-"),i=i.substring(t+1)):(s.push(i.substring(0,r)),i=i.substring(r+1))}
return s.push(i),s}

function addDirectText(e,t,a,s,i,r,o,n){
if(void 0===n&&(n="#202020"),ctx.fillStyle=n,ctx.textAlign=s,a<getDirectWidth(e,t,o))for(t--;
a<getDirectWidth(e,t,o)&&(t--,1);
);
ctx.font=t+"px "+assetLib.textData.langText["font"+e][curLang],ctx.fillText(o,i,r)}

function addText(e,t,a,s,i,r,o,n){
if(void 0===n&&(n="#202020"),ctx.fillStyle=n,ctx.textAlign=s,a<getTextWidth(e,t,o))for(t--;
a<getTextWidth(e,t,o)&&(t--,1);
);
...
for(var s,i="",r=0;
r<a.length;
)s=a.charAt(r),"Bangers"==assetLib.textData.langText["font"+t][curLang]&&"i"==s&&(s="İ"),i+=s,r++;
a=i}
return a}
...
if(a<getTextWidth(e,t,s))for(t--;
a<getTextWidth(e,t,s)&&(t--,1);
);
...
if(!isMobile)for(var e=0;
e<panel.aButs.length;
e++)panel.aButs[e].isOver=!1,userInput.mouseX>panel.aButs[e].aOverData[0]&&userInput.mouseX<panel.aButs[e].aOverData[2]&&userInput.mouseY>panel.aButs[e].aOverData[1]&&userInput.mouseY<panel.aButs[e].aOverData[3]&&(panel.aButs[e].isOver=!0)}
...
a<15;
a++){
var s=canvas.width/2+70*curLevelStars-70*(levelStarTarg/2-.5)-100*panel.starsX,i=Math.max(onScreenY-200,60)-100*panel.starsY,r=new Elements.Particle(s,i,1,200,24*a*radian,100);
aEffects.push(r)}
...
for(var s=canvas.width/2+o,i=Math.max(onScreenY-200,60)-100*panel.starsY-10,a=0;
a<15;
a++){
...
var e=getSpriteData(assetLib.getData("gameElements"),"tableEdge").bWidth,t=(userBat.x-canvas.width/2-500*tableTop.offsetX*tableTop.genScale)/(e*tableTop.genScale/2),a=(userBat.y-(onScreenY+352*(1+tableTop.offsetY/2)+50*tableTop.offsetY))*.18+40;
netLib.send(!1,"batPos",[Math.round(1e3*t)/1e3,Math.round(1e3*a)/1e3,Math.round(1e3*userBat.rotation)/1e3]),networkInc=0}
for(var s=0;
s<aBalls.length;
s++)0==aBalls[s].curBallState&&(curBallId=s),2==aBalls[s].curBallState&&(aBalls.splice(s,1),s-=1);
for(var s=0;
s<aBalls.length;
s++)aBalls[s].update(),s==curBallId&&(0==gameVariation||2==gameVariation||4==gameVariation)&&enemyBat.update(),aBalls[s].offTable||aBalls[s].offSide||aBalls[s].height<0&&aBalls[s].tablePosY<.5&&(aBalls[s].tablePosX<-1||aBalls[s].tablePosX>1)?(aBalls[s].render(),s==curBallId&&(tableTop.render(),(0==gameVariation||2==gameVariation||4==gameVariation)&&enemyBat.render(),tableTop.renderNet())):aBalls[s].tablePosY>.5?(s==curBallId&&(tableTop.render(),(0==gameVariation||2==gameVariation||4==gameVariation)&&enemyBat.render(),tableTop.renderNet()),aBalls[s].render()):aBalls[s].tablePosY<.5&&(1!=gameVariation&&s==curBallId&&aBalls[s].y<enemyBat.y+200*enemyBat.scale-30?(tableTop.render(),aBalls[s].render(),(0==gameVariation||2==gameVariation||4==gameVariation)&&enemyBat.render(),tableTop.renderNet()):(s==curBallId&&(tableTop.render(),(0==gameVariation||2==gameVariation||4==gameVariation)&&enemyBat.render()),aBalls[s].render(),s==curBallId&&tableTop.renderNet()));
...
for(var s=0;
s<aEffects.length;
s++)aEffects[s].update(),aEffects[s].render(),aEffects[s].removeMe&&(aEffects.splice(s,1),s-=1);
...
for(var e=0;
e<aEffects.length;
e++)aEffects[e].update(),aEffects[e].render(),aEffects[e].removeMe&&(aEffects.splice(e,1),e-=1);
...
function getDelta(){
var e=new Date().getTime(),t=(e-previousTime)/1e3;
return previousTime=e,t>.5&&(t=0),t}

function checkSpriteCollision(e,t){
var a=e.x,s=e.y,i=t.x,r=t.y;
...
for(var e,t,a,s=0,i=0,r=0;
r<aLangs.length;
r++)if(e=preAssetLib.getData("lang"+aLangs[r]),(r+1)*(1*e.img.width)+(r+2)*10<canvas.width)s++;
else break;
...
var o={
oImgData:e,aPos:[t+1*e.img.width/2,a+1*e.img.height/2],scale:1,id:"none",noMove:!0}
;
...
id0:{
x:525,y:138,width:132,height:136}
,id1:{
x:525,y:0,width:132,height:136}
,id10:{
x:0,y:548,width:196,height:200}
,id11:{
x:0,y:346,width:196,height:200}
,id12:{
x:0,y:173,width:255,height:171}
,id13:{
x:0,y:0,width:255,height:171}
,id14:{
x:84,y:760,width:82,height:82}
,id15:{
x:168,y:760,width:82,height:82}
,id16:{
x:0,y:760,width:82,height:82}
,id17:{
x:734,y:306,width:82,height:82}
,id18:{
x:600,y:552,width:132,height:136}
,id19:{
x:600,y:414,width:132,height:136}
,id2:{
x:600,y:690,width:132,height:136}
,id20:{
x:600,y:276,width:132,height:136}
,id21:{
x:466,y:690,width:132,height:136}
,id22:{
x:659,y:138,width:82,height:82}
,id23:{
x:734,y:222,width:82,height:82}
,id24:{
x:466,y:552,width:132,height:136}
,id25:{
x:466,y:414,width:132,height:136}
,id26:{
x:466,y:276,width:132,height:136}
,id27:{
x:391,y:138,width:132,height:136}
,id28:{
x:391,y:0,width:132,height:136}
,id29:{
x:332,y:690,width:132,height:136}
,id3:{
x:659,y:0,width:132,height:136}
,id30:{
x:252,y:760,width:54,height:54}
,id31:{
x:793,y:0,width:54,height:54}
,id32:{
x:793,y:56,width:54,height:54}
,id33:{
x:257,y:276,width:54,height:54}
,id34:{
x:257,y:0,width:132,height:136}
,id35:{
x:332,y:414,width:132,height:136}
,id36:{
x:332,y:552,width:132,height:136}
,id37:{
x:198,y:346,width:132,height:136}
,id38:{
x:198,y:622,width:132,height:136}
,id39:{
x:198,y:484,width:132,height:136}
,id4:{
x:734,y:726,width:82,height:82}
,id40:{
x:257,y:138,width:132,height:136}
,id41:{
x:332,y:276,width:132,height:136}
,id5:{
x:734,y:642,width:82,height:82}
,id6:{
x:734,y:558,width:82,height:82}
,id7:{
x:734,y:474,width:82,height:82}
,id8:{
x:734,y:390,width:82,height:82}
,id9:{
x:743,y:138,width:82,height:82}
}
}
,{
id:"flags",file:"images/flags.png",oAtlasData:{
id0:{
x:198,y:297,width:97,height:97}
,id1:{
x:396,y:495,width:97,height:97}
,id10:{
x:297,y:198,width:97,height:97}
,id11:{
x:297,y:99,width:97,height:97}
,id12:{
x:297,y:0,width:97,height:97}
,id13:{
x:198,y:495,width:97,height:97}
,id14:{
x:198,y:396,width:97,height:97}
,id15:{
x:495,y:0,width:97,height:97}
,id16:{
x:198,y:198,width:97,height:97}
,id17:{
x:198,y:99,width:97,height:97}
,id18:{
x:198,y:0,width:97,height:97}
,id19:{
x:99,y:495,width:97,height:97}
,id2:{
x:396,y:396,width:97,height:97}
,id20:{
x:99,y:396,width:97,height:97}
,id21:{
x:99,y:297,width:97,height:97}
,id22:{
x:99,y:198,width:97,height:97}
,id23:{
x:99,y:99,width:97,height:97}
,id24:{
x:99,y:0,width:97,height:97}
,id25:{
x:0,y:495,width:97,height:97}
,id26:{
x:0,y:396,width:97,height:97}
,id27:{
x:0,y:297,width:97,height:97}
,id28:{
x:0,y:198,width:97,height:97}
,id29:{
x:0,y:99,width:97,height:97}
,id3:{
x:396,y:297,width:97,height:97}
,id30:{
x:0,y:0,width:97,height:97}
,id4:{
x:396,y:198,width:97,height:97}
,id5:{
x:396,y:99,width:97,height:97}
,id6:{
x:396,y:0,width:97,height:97}
,id7:{
x:297,y:495,width:97,height:97}
,id8:{
x:297,y:396,width:97,height:97}
,id9:{
x:297,y:297,width:97,height:97}
}
}
,{
...
id0:{
x:0,y:47,width:618,height:51}
,id1:{
x:182,y:1395,width:62,height:62}
,id10:{
x:1226,y:564,width:172,height:280}
,id11:{
x:1310,y:0,width:172,height:280}
,id12:{
x:1400,y:1692,width:172,height:280}
,id13:{
x:1400,y:1128,width:172,height:280}
,id14:{
x:1574,y:1692,width:172,height:280}
,id15:{
x:1574,y:1410,width:172,height:280}
,id16:{
x:1574,y:1128,width:172,height:280}
,id17:{
x:1574,y:846,width:172,height:280}
,id18:{
x:1574,y:564,width:172,height:280}
,id19:{
x:1484,y:0,width:172,height:280}
,id2:{
x:182,y:1357,width:65,height:36}
,id20:{
x:1478,y:282,width:172,height:280}
,id21:{
x:1136,y:0,width:172,height:280}
,id22:{
x:1400,y:1410,width:172,height:280}
,id23:{
x:1304,y:282,width:172,height:280}
,id24:{
x:1400,y:846,width:172,height:280}
,id25:{
x:1400,y:564,width:172,height:280}
,id26:{
x:1226,y:1692,width:172,height:280}
,id27:{
x:1226,y:1410,width:172,height:280}
,id28:{
x:1226,y:1128,width:172,height:280}
,id29:{
x:1226,y:846,width:172,height:280}
,id3:{
x:0,y:845,width:299,height:87}
,id30:{
x:356,y:1409,width:172,height:280}
,id31:{
x:356,y:1127,width:172,height:280}
,id32:{
x:1130,y:282,width:172,height:280}
,id33:{
x:530,y:1409,width:172,height:280}
,id34:{
x:356,y:1691,width:172,height:280}
,id35:{
x:1052,y:1739,width:172,height:280}
,id36:{
x:1052,y:1457,width:172,height:280}
,id37:{
x:1052,y:1175,width:172,height:280}
,id38:{
x:1052,y:893,width:172,height:280}
,id39:{
x:356,y:845,width:172,height:280}
,id4:{
x:0,y:552,width:606,height:13}
,id40:{
x:962,y:0,width:172,height:280}
,id41:{
x:956,y:329,width:172,height:280}
,id42:{
x:878,y:1792,width:172,height:280}
,id43:{
x:878,y:1510,width:172,height:280}
,id44:{
x:878,y:1228,width:172,height:280}
,id45:{
x:878,y:946,width:172,height:280}
,id46:{
x:878,y:664,width:172,height:280}
,id47:{
x:788,y:47,width:172,height:280}
,id48:{
x:782,y:382,width:172,height:280}
,id49:{
x:704,y:1680,width:172,height:280}
,id5:{
x:0,y:0,width:896,height:45}
,id50:{
x:704,y:1398,width:172,height:280}
,id51:{
x:704,y:1116,width:172,height:280}
,id52:{
x:704,y:834,width:172,height:280}
,id53:{
x:614,y:100,width:172,height:280}
,id54:{
x:608,y:552,width:172,height:280}
,id55:{
x:530,y:1691,width:172,height:280}
,id56:{
x:0,y:1780,width:178,height:284}
,id57:{
x:1748,y:920,width:165,height:332}
,id58:{
x:0,y:1214,width:180,height:278}
,id59:{
x:1908,y:1549,width:148,height:286}
,id6:{
x:182,y:1459,width:37,height:21}
,id60:{
x:1748,y:1254,width:158,height:293}
,id61:{
x:1748,y:1549,width:158,height:289}
,id62:{
x:180,y:1786,width:174,height:290}
,id63:{
x:1658,y:0,width:166,height:291}
,id64:{
x:182,y:934,width:172,height:280}
,id65:{
x:0,y:567,width:606,height:49}
,id66:{
x:0,y:326,width:612,height:224}
,id67:{
x:182,y:1216,width:120,height:139}
,id68:{
x:0,y:1494,width:178,height:284}
,id69:{
x:1748,y:586,width:165,height:332}
,id7:{
x:530,y:845,width:172,height:280}
,id70:{
x:0,y:934,width:180,height:278}
,id71:{
x:1915,y:586,width:148,height:286}
,id72:{
x:1908,y:1254,width:158,height:293}
,id73:{
x:1826,y:0,width:158,height:289}
,id74:{
x:180,y:1494,width:174,height:290}
,id75:{
x:1748,y:293,width:166,height:291}
,id76:{
x:0,y:618,width:603,height:225}
,id77:{
x:0,y:100,width:612,height:224}
,id8:{
x:1052,y:611,width:172,height:280}
,id9:{
x:530,y:1127,width:172,height:280}
}
}
,{
id:"uiElements",file:"images/uiElements.png",oAtlasData:{
id0:{
x:193,y:1054,width:70,height:66}
,id1:{
x:271,y:825,width:182,height:177}
,id10:{
x:653,y:1067,width:62,height:58}
,id11:{
x:359,y:1034,width:85,height:86}
,id12:{
x:628,y:751,width:171,height:249}
,id13:{
x:868,y:248,width:167,height:245}
,id14:{
x:801,y:747,width:168,height:245}
,id15:{
x:868,y:0,width:168,height:246}
,id16:{
x:751,y:500,width:168,height:245}
,id17:{
x:404,y:500,width:172,height:281}
,id18:{
x:0,y:1054,width:191,height:70}
,id19:{
x:894,y:1053,width:40,height:37}
,id2:{
x:718,y:1002,width:59,height:60}
,id20:{
x:837,y:994,width:56,height:57}
,id21:{
x:578,y:500,width:171,height:249}
,id22:{
x:455,y:783,width:171,height:249}
,id23:{
x:0,y:792,width:311,height:31}
,id24:{
x:0,y:760,width:311,height:30}
,id25:{
x:921,y:495,width:165,height:242}
,id26:{
x:717,y:1067,width:59,height:60}
,id27:{
x:313,y:760,width:84,height:48}
,id28:{
x:779,y:1002,width:56,height:57}
,id29:{
x:838,y:1053,width:54,height:54}
,id3:{
x:271,y:1017,width:42,height:11}
,id30:{
x:936,y:1044,width:31,height:47}
,id31:{
x:446,y:1034,width:71,height:81}
,id32:{
x:653,y:1002,width:63,height:63}
,id33:{
x:0,y:0,width:866,height:498}
,id34:{
x:0,y:825,width:269,height:227}
,id35:{
x:895,y:994,width:36,height:48}
,id36:{
x:933,y:994,width:36,height:48}
,id37:{
x:0,y:630,width:402,height:128}
,id38:{
x:399,y:783,width:49,height:38}
,id39:{
x:0,y:500,width:402,height:128}
,id4:{
x:271,y:1004,width:42,height:11}
,id40:{
x:315,y:1004,width:33,height:28}
,id5:{
x:519,y:1034,width:65,height:65}
,id6:{
x:271,y:1034,width:86,height:86}
,id7:{
x:971,y:739,width:160,height:248}
,id8:{
x:586,y:1034,width:65,height:65}
,id9:{
x:778,y:1064,width:58,height:56}
}
}
,{
id:"awards",file:"images/awards.png",oAtlasData:{
id0:{
x:294,y:330,width:145,height:163}
,id1:{
x:588,y:330,width:145,height:163}
,id10:{
x:240,y:165,width:145,height:163}
,id11:{
x:240,y:0,width:145,height:163}
,id12:{
x:147,y:591,width:145,height:163}
,id13:{
x:147,y:426,width:145,height:163}
,id14:{
x:0,y:591,width:145,height:163}
,id15:{
x:0,y:426,width:145,height:163}
,id16:{
x:0,y:278,width:153,height:146}
,id17:{
x:0,y:0,width:238,height:276}
,id2:{
x:534,y:165,width:145,height:163}
,id3:{
x:534,y:0,width:145,height:163}
,id4:{
x:441,y:495,width:145,height:163}
,id5:{
x:441,y:330,width:145,height:163}
,id6:{
x:387,y:165,width:145,height:163}
,id7:{
x:387,y:0,width:145,height:163}
,id8:{
x:294,y:495,width:145,height:163}
,id9:{
x:588,y:495,width:145,height:163}
}
}
,{
id:"bugs",file:"images/bugs.png",oAtlasData:{
id0:{
x:124,y:300,width:122,height:115}
,id1:{
x:372,y:194,width:122,height:104}
,id2:{
x:248,y:301,width:122,height:101}
,id3:{
x:248,y:194,width:122,height:105}
,id4:{
x:372,y:300,width:122,height:136}
,id5:{
x:124,y:194,width:122,height:104}
,id6:{
x:0,y:304,width:122,height:105}
,id7:{
x:0,y:194,width:122,height:108}
,id8:{
x:0,y:0,width:502,height:192}
}
}
,{
id:"langText",file:"json/text.json"}
,{
id:"info",file:"images/splashLogo.png"}
,{
id:"bg0",file:"images/bg0.jpg"}
,{
id:"bg1",file:"images/bg1.jpg"}
,{
id:"bg2",file:"images/bg2.jpg"}
,{
id:"bg3",file:"images/bg3.jpg"}
,{
id:"bg4",file:"images/bg4.jpg"}
,{
id:"fadeBg0",file:"images/spinBg0.jpg"}
,{
id:"fadeBg1",file:"images/spinBg1.jpg"}
,{
id:"fadeBg2",file:"images/spinBg2.jpg"}
...
var e,t,a,s,i=window.innerWidth,r=window.innerHeight;
...
case"network":userInput.removeHitArea("urlAreaFromNetwork"),userInput.addHitArea("urlAreaFromNetwork",butEventHandler,null,"rect",{
aRect:[200,200,canvas.width-200,canvas.height-200]}
,!0);
break;

case"game":isMobile&&1==gameplayState?(userInput.removeHitArea("gameTouch"),userInput.addHitArea("gameTouch",butEventHandler,{
isDraggable:!0,multiTouch:!0}
,"rect",{
aRect:[0,100,canvas.width,canvas.height]}
...
case"batShop":userInput.removeHitArea("batShopTouch"),userInput.addHitArea("batShopTouch",butEventHandler,{
isDraggable:!0,multiTouch:!0}
,"rect",{
aRect:[0,0,canvas.width,canvas.height]}
,!0)}
